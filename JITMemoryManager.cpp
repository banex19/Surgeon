 ...
 uint8_t *JITMemoryManager::allocateDataSection(uintptr_t Size,
                                                    ...
                                                    bool IsReadOnly) {
   if (IsReadOnly)
     return allocateSection(JITMemoryManager::AllocationPurpose::ROData,
                            Size, Alignment);
   return allocateSection(JITMemoryManager::AllocationPurpose::RWData, Size,
                          Alignment);
 }
 ...
 uint8_t *JITMemoryManager::allocateCodeSection(uintptr_t Size,
                                                    ...
                                                    unsigned SectionID,
                                                    StringRef SectionName) {
   return allocateSection(JITMemoryManager::AllocationPurpose::Code, Size,
                          Alignment);
 }
 
 uint8_t *JITMemoryManager::allocateSection(
     JITMemoryManager::AllocationPurpose Purpose, uintptr_t Size,
     unsigned Alignment) {
   if (!Alignment)
     Alignment = 16;
   ...
   MemoryGroup &MemGroup = [&]() -> MemoryGroup & {
     ...
     llvm_unreachable("Unknown JITMemoryManager::AllocationPurpose");
   }();
 ...
 void JITMemoryManager::invalidateInstructionCache() {
 ...
 JITMemoryManager::MemoryMapper::~MemoryMapper() {}
 
 void JITMemoryManager::anchor() {}
 
 namespace {
 // Trivial implementation of JITMemoryManager::MemoryMapper that just calls
 // into sys::Memory.
 class DefaultMMapper final : public JITMemoryManager::MemoryMapper {
 public:
   sys::MemoryBlock
   allocateMappedMemory(JITMemoryManager::AllocationPurpose Purpose,
 ...
 JITMemoryManager::JITMemoryManager(MemoryMapper *MM)
