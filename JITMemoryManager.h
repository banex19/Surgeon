...
namespace llvm {
    ...
    /// MCJIT::finalizeObject or by calling JITMemoryManager::finalizeMemory
    ...
    public:
        ...
        /// Implementations of this interface are used by JITMemoryManager to
        ...
        /// Creates a JITMemoryManager instance with \p MM as the associated
        /// memory mapper.  If \p MM is nullptr then a default memory mapper is used
        /// that directly calls into the operating system.
        JITMemoryManager(MemoryMapper *MM = nullptr);
        JITMemoryManager(const JITMemoryManager &) = delete;
        void operator=(const JITMemoryManager &) = delete;
        ~JITMemoryManager() override;
